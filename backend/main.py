...
# plus any origins listed in CORS_ORIGINS (comma-separated, e.g. your Vercel
# frontend URL). TRUSTED_HOSTS additionally restricts the Host header if set.
_cors_origins = [
    value.strip().rstrip("/")
...
app.add_middleware(
    ...
    allow_headers=["Content-Type", "Last-Event-ID", "X-Admin-Token"],
)
