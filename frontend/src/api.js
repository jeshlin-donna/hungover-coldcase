...
export const api = {
  ...
  sampleCases: () => get("/sample-cases"),
  seedSampleCase: (caseId, sampleCase) => post(`/cases/${caseId}/evidence/seed-sample`, { sample_case: sampleCase }),
  updateCase: (caseId, payload) => patch(`/cases/${caseId}`, payload),
  health: () => get("/health"),
  stats: () => get("/stats"),
